                ...
                <div className="w-full max-w-md mx-auto p-8 space-y-3 rounded-xl bg-orange-200">
                    ...
                    <form noValidate="" action="" className="space-y-6">
                        ...
                        <div className="space-y-1 text-sm">
                            ...
                            <input type="text" name="photo" id="photo" placeholder="Your Photo URL" className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" />
                        </div>
                        <div className="space-y-1 text-sm">
