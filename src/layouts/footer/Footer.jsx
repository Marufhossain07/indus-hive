...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-[#181518] text-white font-pop mt-10">
            ...
            <div className="py-6 text-sm border-t border-orange-500 text-center dark:text-gray-600 max-w-[1140px] mx-auto">© 2025 IndusHive. All rights reserved.</div>
        </footer>
    );
};
